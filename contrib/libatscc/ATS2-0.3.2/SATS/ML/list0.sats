...
list0_imap
  {a:t0p}{b:t0p}
(
xs: list0(INV(a)), fopr: cfun(Nat, a, b)
) : list0(b) = "mac#%" // end-of-function
fun
list0_imap_method
  {a:t0p}{b:t0p}
(
xs: list0(INV(a)), TYPE(b))(fopr: cfun(Nat, a, b)
) : list0(b) = "mac#%" // end-of-function
//
