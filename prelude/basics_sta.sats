...
stadef bool1 = bool_bool_t0ype // shorthand
//
(* typedef Bool = [b:bool] bool1 (b) *)
stadef Bool = bool_bool_t0ype

typedef boolLte
  (b1:bool) = [b2:bool] bool1 (b2 <= b1) // b2 -> b1
typedef boolGte
  (b1:bool) = [b2:bool] bool1 (b2 >= b1) // b1 -> b2
//
...
stadef char1 = char_int_t0ype // shorthand
stadef Char = char_int_t0ype // shorthand
//
typedef Char_1 = [c:int8] char1(c)
typedef charNZ = [c:int8 | c != 0] char1(c)
//
// signed characters
//
...
stadef schar1 = schar_int_t0ype // shorthand
stadef SChar = schar_int_t0ype // shorthand
//
typedef sChar = [c:int8] schar1(c)
typedef scharNZ = [c:int8 | c != 0] schar1(c)
//
// unsigned characters
//
...
stadef uchar1 = uchar_int_t0ype // shorthand
stadef UChar = uchar_int_t0ype
//
typedef uChar = [c:uint8] uchar1 (c)
typedef scharNZ = [c:uint8 | c != 0] uchar1(c)
//
(* ****** ****** *)
...
typedef sizeof_t (a:vt@ype) = size1_t (sizeof(a?))
...
typedef String_1 = [n:int] string_int_type(n)
...
abst@ype
int_t0ype = $extype"atstype_int"
typedef 
int = int_t0ype

abst@ype
uint_t0ype = $extype"atstype_uint"
typedef 
uint = uint_t0ype


abst@ype
string_t0ype = $extype"atstype_string"
typedef 
string = string_t0ype
...
abst@ype 
atsvoid_t0ype (*= $extype"atsvoid_t0ype"*)
typedef 
...
abstype 
ptr_type = tkind_type(ptr_kind)
abstype 
ptr_addr_type(l:addr) = ptr_type
typedef 
ptr = ptr_type // HX: a shorthand
typedef 
ptr(l:addr) = ptr_addr_type(l) // HX: a shorthand
typedef Ptr = [l:addr] ptr(l)
typedef Ptr0 = [l:agez] ptr(l)
typedef Ptr1 = [l:addr|l > null] ptr(l)
typedef
