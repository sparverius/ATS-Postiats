...
(* ****** ****** *)
//
castfn g0ofg1_char{c:int8}(c: Char(c)):<> char
castfn g1ofg0_char(c: char):<> [c:int8] Char(c)
//
...
castfn
char2schar1
  {c:int}(c: char1(c)):<> schar1(c)
castfn
schar2char1
  {c:int}(c: schar1(c)):<> char1(c)
//
castfn
char2uchar1
  {c:int}(c: char1(c)):<> uchar1(i2u8(c))
castfn
uchar2char1
  {c:int}(c: uchar1(c)):<> char1(u2i8(c))
//
(* ****** ****** *)
//
fun
char2int1
  {c:int}(c: char1(c)):<> int1(c) = "mac#%"
fun
schar2int1
  {c:int}(c: schar1(c)):<> int1(c) = "mac#%"
fun
uchar2int1
  {c:int}(c: uchar1(c)):<> int1(c) = "mac#%"
//
(* ****** ****** *)
//
fun
char1_iseqz
  {c:int}(c: char1(c)):<> Bool(c == 0) = "mac#%"
fun
char1_isneqz
  {c:int}(c: char1(c)):<> Bool(c != 0) = "mac#%"
//
