...
fun
ptr1_is_null
  {l:addr}(p: ptr l):<> bool1 (l==null) = "mac#%"
fun
ptr1_isnot_null
  {l:addr}(p: ptr l):<> bool1 (l > null) = "mac#%"
//
...
fun
gt_ptr1_intz{l:addr}
  (p: ptr(l), i: int1(0)):<> bool1(l > null) = "mac#%"
fun
eq_ptr1_intz{l:addr}
  (p: ptr(l), i: int1(0)):<> bool1(l== null) = "mac#%"
fun
...
fun
cptr_is_null
  {a:vt0p}{l:addr}(cp: cptr(a, l)):<> bool1(l==null) = "mac#%"
fun
cptr_isnot_null
  {a:vt0p}{l:addr}(cp: cptr(a, l)):<> bool1(l > null) = "mac#%"
//
...
gt_cptr_intz
  {a:vt0p}{l:addr}
  (cp: cptr(a, l), i: int1(0)):<> bool1(l > null) = "mac#%"
//
fun
eq_cptr_intz
  {a:vt0p}{l:addr}
...
aptr_is_null
{a:vt0p}{l:addr}
  (ap: !aptr(INV(a), l)):<> bool1(l==null) = "mac#%"
fun
aptr_isnot_null
{a:vt0p}{l:addr}
  (ap: !aptr(INV(a), l)):<> bool1(l > null) = "mac#%"
