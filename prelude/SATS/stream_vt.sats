...
//
vtypedef
streamopt_vt(a:vt0p) = Option_vt_1(stream_vt(a))
//
(* ****** ****** *)
//
fun
...
stream_vt_uncons_opt
  (xs: &stream_vt(INV(a)) >> _):<!exnwrt> Option_vt_1(a)
//
(* ****** ****** *)
//
fun{a:t0p}
...
fun{a:t0p}
stream_vt_last_opt
  (stream_vt(INV(a))):<!exnwrt> Option_vt_1(a)
//
(* ****** ****** *)
//
fun{a:t0p}
...
fun{a:t0p}
stream_vt_nth_opt
  (xs: stream_vt(INV(a)), n: intGte(0)):<!wrt> Option_vt_1(a)
//
(* ****** ****** *)
//
fun{a:vt0p}
...
{a:vt0p}
{b:vt0p}
stream_vt_mapopt$fopr(x: &a >> a?!): Option_vt_1(b)
//
fun{
a:vt0p}{b:vt0p
} stream_vt_mapopt_fun
(
xs: stream_vt(INV(a)), fopr: (&a >> a?!) -<fun1> Option_vt_1(b)
) : stream_vt(b) // end-of-function
fun{
a:vt0p}{b:vt0p
} stream_vt_mapopt_cloptr
(
xs: stream_vt(INV(a)), fopr: (&a >> a?!) -<cloptr1> Option_vt_1(b)
) : stream_vt(b) // end-of-function
//
(* ****** ****** *)
//
...
(
  st0: env, fopr: (&env >> _) -<cloref1> Option_vt_1(a)
...
fun
{x,y:t0p}
cross_stream_vt_List{n:nat}
(xs: stream_vt(INV(x)), ys: List(INV(y), n)): stream_vt(@(x, y))
fun
{x,y:t0p}
cross_stream_vt_List_vt{n:nat}
(xs: stream_vt(INV(x)), ys: List_vt(INV(y), n)): stream_vt(@(x, y))
//
(* ****** ****** *)
//
// HX-2016-07-01:
...
fun{
a:vt@ype
} streamer_vt_eval_opt(xser: !streamer_vt(INV(a))): Option_vt_1(a)
//
(* ****** ****** *)
//
