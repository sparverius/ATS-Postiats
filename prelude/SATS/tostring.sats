...
{a:t0p}
tostrptr_List{n:nat}
  (xs0: List(INV(a), n)): Strptr1
//
fun{}
tostrptr_List$beg((*void*)): [n:nat] String n
fun{}
tostrptr_List$end((*void*)): [n:nat] String n
fun{}
tostrptr_List$sep((*void*)): [n:nat] String n
//
(* ****** ****** *)
//
fun
...
//
fun{}
tostrptr_array$beg((*void*)): [n:nat] String n
fun{}
tostrptr_array$end((*void*)): [n:nat] String n
fun{}
tostrptr_array$sep((*void*)): [n:nat] String n
//
(* ****** ****** *)
//
fun
