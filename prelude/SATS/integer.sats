...
fun{}
add_int1_size0{i:nat}(int1(i), size_t):<> size_t
fun{}
add_size0_int1{j:nat}(size_t, int1(j)):<> size_t
...
fun{}
mul_int1_size0{i:nat}(int1(i), size_t):<> size_t
fun{}
mul_size0_int1{j:nat}(size_t, int1(j)):<> size_t
...
//
fun
g1int2int_int_int{i:int}(int1(i)):<> int1(i) = "mac#%"
//
(* ****** ****** *)
...
add_size1_int1
  {i,j:int | i+j >= 0}
  (i: size1_t(i), j: int1(j)):<> size1_t(i+j)
fun{}
add_int1_size1
  {i,j:int | i+j >= 0}
  (i: int1(i), j: size1_t(j)):<> size1_t(i+j)
//
(* ****** ****** *)
...
nmod_g1int_int1
  {i,j:int | i >= 0; j > 0}
  (x: g1int(tk, i), y: int1(j)):<> int1(i%j)
//
fun{tk:tk}
nmod2_g1int_int1
  {i,j:int | i >= 0; j > 0}
(
  x: g1int(tk, i), y: int1(j)
) :<> [q,r:nat | r < j] (DIVMOD(i, j, q, r) | int1(r))
//
...
compare_g1int_int{i,j:int}
  (g1int(tk, i), int1(j)):<> int1(sgn(i-j))
//
...
fun
{tk:tk}
g1int_sgn{i:int}(g1int(tk, i)):<> int1(sgn(i))
...
castfn
size_of_int{i:nat}(x: int1(i)):<> size1_t(i)
castfn
ssize_of_int{i:int}(x: int1(i)):<> ssize1_t(i)
...
Listize_g0int_rep
  {b:int | b >= 2}
  (g0int(tk), int1(b)):<!wrt> List0_vt(intBtw(0, b))
//
fun{tk:tk}
Listize_g0uint_rep
  {b:int | b >= 2}
  (g0uint(tk), int1(b)):<!wrt> List0_vt(intBtw(0, b))
//
(* ****** ****** *)
